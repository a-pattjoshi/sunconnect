...
const SC_VENDORS = [
  {
    ...
    reviews: [
      { author: "Ramesh T.",  initials: "RT", rating: 5, date: "Mar 2026", text: "Excellent service! Satish walked us through every step. Installation was clean and the RMS monitoring is working perfectly. Electricity bill dropped from ₹4,200 to ₹600/month." },
      { author: "Kavitha M.", initials: "KM", rating: 4, date: "Feb 2026", text: "Good quality work. Subsidy credited in 45 days. Minor delay in meter approval but overall very satisfied — panels generating exactly as promised." },
      { author: "Pradeep S.", initials: "PS", rating: 5, date: "Jan 2026", text: "Highly recommended! Tata Solar panels and the roof work was done perfectly — absolutely zero leaks after the monsoon last year. Very professional team." },
      { author: "Meena R.",   initials: "MR", rating: 4, date: "Dec 2025", text: "Professional team, transparent about pricing. Only suggestion: a WhatsApp status update during subsidy processing would be helpful." }
    ]
  },
  {
    id: 2, icon: '🌞',
    ...
    services: ["Residential Solar", "Commercial Solar", "Good Zero Performance Guarantee", "EMI Financing", "App-based Monitoring"],
    ...
    reviews: [
      { author: "Arun K.",    initials: "AK", rating: 5, date: "Apr 2026", text: "Solar Square's Good Zero plan gave me full confidence. Installation done in 9 days flat. App monitoring is brilliant — real-time generation data on my phone." },
      { author: "Shalini P.", initials: "SP", rating: 5, date: "Mar 2026", text: "Absolutely professional. They handled everything — BESCOM inspection, subsidy paperwork, grid integration. Zero hassle for us." },
      { author: "Vikram B.",  initials: "VB", rating: 4, date: "Feb 2026", text: "Great product and support. Only downside was subsidy took 52 days (they quoted 45). Otherwise flawless experience." },
      { author: "Deepa N.",   initials: "DN", rating: 5, date: "Jan 2026", text: "Worth every rupee. The performance guarantee is real — they credited me ₹480 in one month when generation was low due to dust." }
    ]
  },
  {
    id: 3, icon: '⚡',
    ...
    about: "Apollo Solar Solutions does ~10 installations per month, strictly B2C residential. Average project cost ₹1.5–2 lakhs. We maintain ready stock of 10–15 kW capacity and use only authorised distributor materials with 25-year system lifespan guarantee.",
    ...
    reviews: [
      { author: "Mohan S.",   initials: "MS", rating: 4, date: "Apr 2026", text: "Prashant is a very honest person. He didn't oversell and gave exactly the system I needed. Adani panels, clean installation." },
      { author: "Rekha V.",   initials: "RV", rating: 5, date: "Mar 2026", text: "Excellent value for money. Best price I got across 6 quotes. Installation in 22 days, subsidy in 40 days." },
      { author: "Suresh G.",  initials: "SG", rating: 4, date: "Jan 2026", text: "Good work, reliable team. Prashant personally supervised the installation. Would recommend for South Bangalore residents." }
    ]
  },
  {
    id: 4, icon: '🔆',
    ...
    about: "Charvi Solar Solution has 10 years of experience catering to B2C customers across central Karnataka and Bangalore. They leverage social media (Facebook) and word-of-mouth. Planning direct tie-ups with financing institutions for easier customer EMI options.",
    ...
    reviews: [
      { author: "Ashwin T.",  initials: "AT", rating: 4, date: "Mar 2026", text: "Rajendra Prasad has deep knowledge. 10 years experience shows — he diagnosed a shading issue I didn't even know about and redesigned the layout." },
      ...
      { author: "Nitin R.",   initials: "NR", rating: 3, date: "Jan 2026", text: "Work quality is good but communication could be better. Had to follow up multiple times for subsidy status. Results were excellent though." }
    ]
  },
  {
    id: 5, icon: '🌤',
    ...
    about: "SuryamTech is a Tata Power Channel Partner serving domestic, residential, and C&I clients. Leads come through online marketing (Google & Meta Ads), direct Tata Power leads, and word-of-mouth referrals. Word-of-mouth converts at ~90%.",
    ...
    reviews: [
      { author: "Kiran M.",   initials: "KM", rating: 5, date: "Apr 2026", text: "Tata Solar panels from an authorised partner — couldn't ask for more. Excellent installation quality and prompt after-sales service." },
      { author: "Nandini S.", initials: "NS", rating: 5, date: "Mar 2026", text: "Very professional. Ravi Kumar personally came for the initial site survey. The entire team is knowledgeable and courteous." },
  ...
  {
    id: 6, icon: '🌻',
    name: "Aayush Solar", owner: "Aayush Sharma",
    ...
    about: "Aayush Solar serves a wide range of clients — residential families, industries, hospitals, and commercial spaces. We use Solar Trade App for instant 30-second quotations. 50–60% of customers finance their installations; 40% pay upfront.",
    ...
    reviews: [
      { author: "Suresh P.",  initials: "SP", rating: 4, date: "Apr 2026", text: "Aayush is a young and dynamic entrepreneur. Quick response, got my quotation in 2 minutes over WhatsApp. Installation was smooth." },
      { author: "Lakshmi T.", initials: "LT", rating: 5, date: "Feb 2026", text: "Excellent service for our factory solar setup. Aayush's team handled everything professionally. Highly recommend for industrial clients." },
  ...
  },
  {
    ...
    about: "Anil Construction Solar is a growing firm with strong customer demand — 33 installation requests in pipeline. We are working on bank loan tie-ups to ease the financing bottleneck. Strong social proof: every completed project brings 3–5 new referrals.",
    ...
    reviews: [
      { author: "Praveen N.", initials: "PN", rating: 4, date: "Mar 2026", text: "Anil is very sincere. He is a new player but very dedicated. Got a good price and the installation quality is solid." },
      { author: "Geetha S.",  initials: "GS", rating: 4, date: "Feb 2026", text: "Reasonable pricing and honest communication. There was a small delay due to bank loan processing, but Anil kept me updated." },
  ...
  },
  {
    ...
    about: "Dynamic Control transitioned from electrical equipment to solar after COVID. Revenue scaled from ₹50–60 lakhs (2021) to ₹15 crores+ today. A dedicated team of 22 in-house staff and 40 contract installers. Diversified lead channels: Tata, PM Surya Ghar portal, social media, and expos.",
    ...
    reviews: [
      { author: "Anand K.",   initials: "AK", rating: 5, date: "Apr 2026", text: "Dynamic Control is the real deal. Swapan has scaled his business impressively — you can tell from the professionalism. Installation in 18 days." },
      { author: "Sunita R.",  initials: "SR", rating: 5, date: "Mar 2026", text: "Best solar company in Bellandur area. Tata panels with full authorized warranty. Excellent after-sales support." },
      { author: "Rajesh M.",  initials: "RM", rating: 4, date: "Feb 2026", text: "Very good company. Big team means they can handle multiple projects at once. My hospital's 30 kW setup was done in 21 days." }
    ]
  },
  {
    id: 9, icon: '🔬',
    name: "Manav Solar", owner: "Akhil Mehta",
    email: "akhil@manavsolar.com", phone: "9880123456",
    ...
    about: "Manav Solar is India's pioneer in 3D solar geometry — trapping more light than standard 2D panels without using additional land. While primarily B2B/B2G for large infra, they also do premium residential installations in Bangalore for tech-forward homeowners seeking maximum efficiency.",
    ...
    reviews: [
      { author: "Dr. Sharma", initials: "DS", rating: 5, date: "Apr 2026", text: "Manav Solar is in a league of their own. The 3D panel technology is genuinely impressive — 28% more generation than my neighbor's conventional system." },
      { author: "Ananya T.",  initials: "AT", rating: 5, date: "Mar 2026", text: "Premium price but absolutely worth it. Akhil is an engineer-entrepreneur who knows solar physics inside out. Best ROI analysis I've seen." },
      { author: "Prashant G.",initials: "PG", rating: 5, date: "Feb 2026", text: "Exceptional quality and after-sales. If you want the best system money can buy in Bangalore, this is the one." }
    ]
  },
  {
    id: 10, icon: '🔌',
    name: "GoodWe Solutions BLR", owner: "Anirudh Nair",
    email: "anirudh@goodwe-blr.com", phone: "9876543210",
    ...
    about: "GoodWe Solutions BLR is the authorised installer partner for GoodWe — a globally recognised Tier-1 inverter brand. Anirudh ensures no corner-cutting on Balance of System (BOS) components — a key differentiator in a market that often compromises on cables, mountings, and connectors.",
    ...
    reviews: [
      { author: "Subhash K.", initials: "SK", rating: 5, date: "Apr 2026", text: "GoodWe inverter is top-notch. Anirudh insisted on branded BOS components even though it cost a bit more — 2 years later, zero issues while neighbors have had failures." },
      { author: "Kavitha R.", initials: "KR", rating: 5, date: "Mar 2026", text: "The technical proposal Anirudh provided was the most detailed I received — actual ROI, payback period, year-by-year savings. Gave us full confidence." },
      { author: "Manoj T.",   initials: "MT", rating: 4, date: "Feb 2026", text: "Excellent technical knowledge. GoodWe inverter is whisper quiet. Would give 5 stars but installation took 36 days (slight delay from BESCOM)." }
    ]
  }
];
...
const SC_LEADS = [
  { id:1,  customer:"Rohit Verma",     area:"Whitefield",    system:"3 kW",  type:"Residential", bill:"₹3,500/mo", status:"new",       date:"14 May 2026", phone:"9900112233", notes:"Wants panels on flat terrace. Interested in Tata brand. Ready to proceed quickly." },
  { id:2,  customer:"Anita Krishnan",  area:"Marathahalli",  system:"5 kW",  type:"Residential", bill:"₹6,200/mo", status:"contacted", date:"12 May 2026", phone:"9911223344", notes:"Has seen neighbor's system. Wants subsidy info and EMI options." },
  { id:3,  customer:"Srinivas G.",     area:"Whitefield",    system:"10 kW", type:"Commercial",  bill:"₹18,000/mo",status:"quote_sent", date:"10 May 2026", phone:"9922334455", notes:"Office building. Wants branded panels only. Budget ₹5–6 lakhs." },
  { id:4,  customer:"Lakshmi Devi",    area:"Brookefield",   system:"3 kW",  type:"Residential", bill:"₹2,800/mo", status:"new",       date:"14 May 2026", phone:"9933445566", notes:"First-time solar buyer. Needs education on subsidy. Referred by Ramesh T." },
  { id:5,  customer:"Ravi Shankar",    area:"KR Puram",      system:"7 kW",  type:"Residential", bill:"₹8,400/mo", status:"contacted", date:"11 May 2026", phone:"9944556677", notes:"Joint family. High consumption due to 3 ACs. Wants maximum output." },
  { id:6,  customer:"Meenakshi V.",    area:"Kadugodi",      system:"4 kW",  type:"Residential", bill:"₹4,100/mo", status:"won",       date:"05 May 2026", phone:"9955667788", notes:"Project confirmed. Advance paid. Survey completed 08 May." },
  { id:7,  customer:"Suresh Babu",     area:"Whitefield",    system:"15 kW", type:"Commercial",  bill:"₹32,000/mo",status:"lost",      date:"03 May 2026", phone:"9966778899", notes:"Chose another vendor for lower price. No quality consideration." },
  { id:8,  customer:"Pooja Nair",      area:"Marathahalli",  system:"3 kW",  type:"Residential", bill:"₹3,200/mo", status:"new",       date:"14 May 2026", phone:"9977889900", notes:"Just moved in. Wants solar as part of new home setup. Very keen." }
];
